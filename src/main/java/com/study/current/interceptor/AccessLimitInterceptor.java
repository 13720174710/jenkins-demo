package com.study.current.interceptor;

import com.study.current.annotation.AccessLimit;
import com.study.current.common.Constant;
import com.study.current.util.IpUtil;
...
public class AccessLimitInterceptor implements HandlerInterceptor {
    ...
    private void check(AccessLimit annotation, HttpServletRequest request) {
        ...
        if (!exists) {
            ...
            int count = Integer.valueOf((Integer) redisUtil.get(key));
            if (count < maxCount) {
